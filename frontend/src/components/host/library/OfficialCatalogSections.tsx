/**
 * <OfficialCatalogSections /> — feat/host-tv-catalog-parity-v2
 *
 ...
 *
 * Perf : pas de framer-motion par carte (ThemeCard utilise des transitions CSS
 * pures depuis Phase 1), pas de IntersectionObserver par carte (un seul, géré
 * par useFocusedPlaylistSync), images en loading="lazy".
 */
